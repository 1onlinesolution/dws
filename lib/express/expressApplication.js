...
class ExpressApplication {
  ...
  addErrorNotFoundHandler(errorNotFoundHandler) {
    if (errorNotFoundHandler) {
      this.errorNotFoundHandler = errorNotFoundHandler;
...
function initializeApplication(expressApp) {
  ...
  // Errors/NotFound
  if (expressApp.errorNotFoundHandler) expressApp.app.use(expressApp.errorNotFoundHandler);
  if (expressApp.errorHandler) expressApp.app.use(expressApp.errorHandler);
}
