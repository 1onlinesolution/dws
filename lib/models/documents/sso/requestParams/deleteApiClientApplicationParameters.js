...
class DeleteApiClientApplicationParameters {
  ...
  static checkForError(parameters) {
    ...
    if (!Validity.isValidString(parameters.api_client_application_id, ApiClientApplication.clientIdLength)) return new Error('invalid api client application identifier');
    return null;
  }
}
